		...
		<div>
			...
			<div className="md:grid md:grid-cols-2 gap-10 mb-20 flex flex-col-reverse justify-between w-full">
				<div className="w-full">
					<header className="text-[1.5rem] font-medium text-white mb-5">Add Music file</header>
					<FileUploader
						...
						types={fileTypes}
						children={
							<div className="w-full max-w-[500px] h-[272px] bg-[#D8043DAD] rounded-lg flex flex-col items-center justify-center">
								<img src="/images/cloud.jpeg" alt="" className="rounded-full w-32 h-32" />
          ...
          /> */}
					...
					<input
						...
						type="text"
						id="lname"
						className="placeholder:text-[#707070]"
						name="price"
				...
				<div>
					<header className="text-[1.5rem] mb-5 font-medium text-white">NFT Information Details</header>
					<div className="w-full">
						<input
					...
					<select onChange={(e) => setCategory(e.target.value)} id="category" className='w-1/2' name="category">
